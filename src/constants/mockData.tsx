...
export const steps = [
  { ru: "Для получения справки необходимо авторизоваться на портале и перейти по кнопке «Заказать услугу», заполнить заявку и подписать ее ЭЦП (электронной цифровой подписью) либо при помощи смс-пароля (обязательно иметь регистрацию в базе мобильных граждан), в личном кабинете (в разделе «История получения услуг») ознакомиться с уведомлением об обработке вашей заявки, которое поступит в течение указанного времени.", kk: "Қадам 1", en: "Step 1" },
